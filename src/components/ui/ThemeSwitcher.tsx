...
export default function ThemeSwitcher() {
    ...
    useEffect(() => {
        ...
        if (saved) {
            ...
            if (themeObj && themeObj.class) {
                // We use setAttribute here instead of className to avoid React immutability warnings
                // while preserving the original logic of only setting a class if one exists.
    ...
    const handleThemeChange = (themeId: string) => {
        ...
        // Clear classes and apply newly selected theme safely
